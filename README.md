...
Built using React, TypeScript, Firebase, and Google Gemini, Mentora delivers personalized learning paths, real-time AI tutoring, and intelligent performance tracking in one seamless experience.

---

## Overview

Traditional learning platforms are static. Mentora AI is adaptive and intelligent.

It:
- Understands user learning patterns  
- Identifies weak areas  
- Generates quizzes automatically  
- Caches AI responses to reduce API usage  
- Tracks performance in real time  
- Syncs progress across devices  

Mentora AI acts as a personalized study companion.
...
```bash
git clone https://github.com/your-username/Mentora-ai1.git
cd Mentora-ai1
```
...
- Gamification and learning streak system  
- Peer study rooms  
